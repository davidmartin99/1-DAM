...
public class FuncionesEmpleados {
          ...
          public static void mostrarEmpleadosAntiguos() throws SQLException {
                    Consultas_Metodos consultas = new Consultas_Metodos();
                    String consulta2 = "SELECT * FROM empleadosAntiguos ORDER BY fechaFinalizacion desc";
                    consultas.imprimirEmpleadosAntiguos(consulta2);
          }//Fin mostrarEmpleadosAntiguos

          public static void imprimirApellidos() throws SQLException {
                    Consultas_Metodos consultas = new Consultas_Metodos();
                    String consulta3 = "SELECT apellidos FROM empleados ORDER BY apellidos desc";
                    consultas.imprimirApellidos(consulta3);
          }//Fin mostrarEmpleadosAntiguos
          
          public static void actualizarSalarioEmpleado() {
                    boolean empleadoEncontrado = false;
                    Scanner scanner = new Scanner(System.in);
                    ...
                    do {
                              try {
                                        ...
                                        // Ejecutar la consulta y mostrar el empleado si se encuentra
                                        ...
                                        if (resultado.next()) {
                                                  ...
                                                  System.out.println("Salario actual: " + resultado.getDouble("salario"));

                                                  // Solicitar el nuevo salario
                                                  System.out.println("Ingrese el nuevo salario del empleado:");
                                                  double nuevoSalario = scanner.nextDouble();

                                                  // Consulta SQL para actualizar el salario del empleado
                                                  String consultaActualizarSalario = "UPDATE empleados SET salario = " + nuevoSalario
                                                          + " WHERE nombre = '" + nombreBuscar + "' AND apellidos = '" + apellidoBuscar + "'";

                                                  // Ejecutar la consulta para actualizar el salario
                                                  consultas.ejecutarInstruccion(consultaActualizarSalario);
