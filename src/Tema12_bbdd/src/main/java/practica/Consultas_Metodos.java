...
public class Consultas_Metodos {
          ...
          public void imprimirEmpleadosAntiguos(String consulta2) throws SQLException {
                    ResultSet resultadoDatos = null;
                    ...
                    try {
                              ...
                              if (resultadoDatos.next()) {
                                        ...
                                        do {
                                                  ...
                                                  // Imprimir detalles del empleado antiguo
                                                  System.out.println(num + ".");
                                                  System.out.println("Nombre: " + nombre);
                                                  System.out.println("Apellidos: " + apellidos);
                                                  System.out.println("Fecha de Nacimiento: " + fechaNacimiento);
                                        ...
                                        System.out.println("No se encontraron empleados antiguos.");
                              }
                    } catch (SQLException e) {
          ...
          }//Fin imprimirEmpleadosAntiguos

          public void imprimirApellidos(String consulta3) throws SQLException {
                    ResultSet resultadoDatos = null;

                    try {
                              conectar();
                              crearSentencia();
                              resultadoDatos = sentencia.executeQuery(consulta3);
