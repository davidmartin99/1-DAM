         ...
         public static void main(String[] args) throws IOException {
                  ...
                  if(!fichero1.exists()){
                           ...
                           try{
                                    ...
                                    BufferedReader br = new BufferedReader(new FileReader(".\\src\\ej3_escritura\\prueba2.txt"));
                                    BufferedWriter bw = new BufferedWriter(new FileWriter(".\\src\\ej3_escritura\\prueba2.txt"));
