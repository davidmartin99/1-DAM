...
public class MenuRuletaRusa {
          public static void inicializarMenu() {
                    ...
                    do {
                              ...
                              System.out.println("--- 3. Mostrar Vivos");
                              ...
                              try {
                                        ...
                                        switch (opcion) {
                                                  case 1:
                                                            FuncionesRuletaRusa.empezarPartida();
                                                            break;
                                                  case 2:
                                                            FuncionesRuletaRusa.mostrarRecords();
                                                            break;
                                                  case 3:
                                                            FuncionesRuletaRusa.mostrarVivos();
                                                            break;
                                                  case 4:
