...
public class SocioGestion {
    ...
    static String rutaSocios = ".\\src\\coleccionesDatos\\socios.txt";
    static String rutaSociosAntiguos = ".\\src\\coleccionesDatos\\sociosAntiguos.txt";
    ...
    static void guardarAltaEnArchivo(Socio socio) {
        ...
        File archivo = new File(".\\src\\coleccionesDatos\\alta_" + nombreArchivo + ".txt");
    ...
    static void guardarBajaEnArchivo(Socio socio) {
        System.out.print("Introduce el nombre del archivo para este socio (sin .txt): ");
        String nombreArchivo = sc.next();
        File archivo = new File(".\\src\\coleccionesDatos\\baja_" + nombreArchivo + ".txt");
